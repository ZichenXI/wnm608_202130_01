...
$thumbs_elements = array_reduce($thumbs,function($r,$o){
   return $r."<img src='$o' style='height:200px;width:200px;'>";
});
...
<div class="card soft">
   <div class="display-flex">
      ...
      <div>
         <a href="{$_SERVER['PHP_SELF']}?id=$id&crud=delete">
            <img src="$product->image_thumb" class="icon" style="height:100px;width:100px;">
         </a>
      </div>
   </div>
   <div>
   ...
   <div>
      ...
      <div class="image-thumbs"><img src='$product->image_thumb' style='height:200px;width:200px;'></div>
